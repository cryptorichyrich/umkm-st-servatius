...
export default function BusinessDetail({ slug: propSlug }: Props) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      {(business.has_nib || business.has_pirt || business.has_halal) && (
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            {business.has_pirt && (
              <div className="flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3.5 py-2.5" title="Pangan Industri Rumah Tangga — bersertifikat standar pangan">
            ...
            {products.map((p) => {
              ...
              return (
                <div key={p.id} className="group flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white transition hover:border-gold-400 hover:shadow-soft">
                  <a href={`/${business.slug}/${p.slug}`} className="block">
                  ...
                  <div className="flex flex-1 flex-col p-3">
                    <a href={`/${business.slug}/${p.slug}`}><h3 className="font-display text-sm font-bold leading-snug text-ink break-words hover:text-paroki-700">{p.name}</h3></a>
